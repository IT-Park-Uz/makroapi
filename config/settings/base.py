...
MIGRATION_MODULES = {"sites": "makro_uz.contrib.sites.migrations"}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = "makro_uz.users.adapters.AccountAdapter"
# # https://django-allauth.readthedocs.io/en/latest/forms.html
# ACCOUNT_FORMS = {"signup": "makro_uz.users.forms.UserSignupForm"}
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# SOCIALACCOUNT_ADAPTER = "makro_uz.users.adapters.SocialAccountAdapter"
# # https://django-allauth.readthedocs.io/en/latest/forms.html
# SOCIALACCOUNT_FORMS = {"signup": "makro_uz.users.forms.UserSocialSignupForm"}
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Makromarket Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Makromarket.uz",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Makromarket.uz",
    ...
    "welcome_sign": "Добро пожаловать в админку Makromarket",
    ...
    "topmenu_links": [
        ...
        {"name": "Перейти на сайт", "url": "https://makromarket.uz", "new_window": True},
    ...
    "usermenu_links": [
        {"name": "Поддержка", "url": "https://t.me/Hiro_Sakurai", "new_window": True},
        {"model": "auth.user"}
    ],
